Public Class QGlobal
    ...
    Private Shared Sub InitPools()
        ...
        Pools(2).Name = "Dobropool aka 100PB online"
        Pools(2).Address = "100pb.online"
        Pools(2).Port = "8124"
        Pools(2).BurstAddress = "BURST-TNHA-2CVB-UQQ8-A9XCQ"
        Pools(2).DeadLine = "604800"

        Pools(3).Name = "pool poolofd32th"
        Pools(3).Address = "pool.poolofd32th.club"
        Pools(3).Port = "8124"
        Pools(3).BurstAddress = "BURST-GATX-U4KB-7AWU-H3N8S"
        Pools(3).DeadLine = "2592000"

        Pools(4).Name = "xen poolofd32th"
        Pools(4).Address = "xen.poolofd32th.club"
        Pools(4).Port = "8122"
        ...
        Pools(7).Port = "8080"
        Pools(7).BurstAddress = "BURST-UTS4-HPFZ-XJHL-B9BB2"
        Pools(7).DeadLine = "43200000"

        Pools(8).Name = "pool.burstpay.net"
        Pools(8).Address = "pool.burstpay.net"
        Pools(8).Port = "8124"
